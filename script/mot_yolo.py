...
# subl /home/kevin/.local/lib/python3.8/site-packages/motrackers/detectors/yolo.py
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--video', '-v', type=str, default="yolo/700.mp4", help='Input video path.')
