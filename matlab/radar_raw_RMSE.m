...
path1=GetPointLineDistance(radar_raw_scene1(i,1),radar_raw_scene1(i,2), ...
                            -1*route3_p2(1,1),route3_p2(2,1), ...
                            -1*route3_p2(1,2),route3_p2(2,2));

path2=GetPointLineDistance(radar_raw_scene1(i,1),radar_raw_scene1(i,2), ...
                            -1*route3_p2(1,2),route3_p2(2,2), ...
                            -1*route3_p2(1,3),route3_p2(2,3));

path3=GetPointLineDistance(radar_raw_scene1(i,1),radar_raw_scene1(i,2), ...
                            -1*route3_p2(1,3),route3_p2(2,3), ...
...
path1=GetPointLineDistance(radar_raw_scene1(i,3),radar_raw_scene1(i,4), ...
                            -1*route3_p1(1,1),route3_p1(2,1), ...
                            -1*route3_p1(1,2),route3_p1(2,2));

path2=GetPointLineDistance(radar_raw_scene1(i,3),radar_raw_scene1(i,4), ...
                            -1*route3_p1(1,2),route3_p1(2,2), ...
                            -1*route3_p1(1,3),route3_p1(2,3));

path3=GetPointLineDistance(radar_raw_scene1(i,3),radar_raw_scene1(i,4), ...
                            -1*route3_p1(1,3),route3_p1(2,3), ...
...
path1=GetPointLineDistance(radar_raw_scene2(i,3),radar_raw_scene2(i,4), ...
                            -1*route2_p1(1,1),route2_p1(2,1), ...
                            -1*route2_p1(1,2),route2_p1(2,2));

path2=GetPointLineDistance(radar_raw_scene2(i,3),radar_raw_scene2(i,4), ...
                            -1*route2_p1(1,2),route2_p1(2,2), ...
                            -1*route2_p1(1,3),route2_p1(2,3));

path3=GetPointLineDistance(radar_raw_scene2(i,3),radar_raw_scene2(i,4), ...
                            -1*route2_p1(1,3),route2_p1(2,3), ...
...
path1=GetPointLineDistance(radar_raw_scene2(i,1),radar_raw_scene2(i,2), ...
                            -1*route2_p2(1,1),route2_p2(2,1), ...
                            -1*route2_p2(1,2),route2_p2(2,2));

path2=GetPointLineDistance(radar_raw_scene2(i,1),radar_raw_scene2(i,2), ...
                            -1*route2_p2(1,2),route2_p2(2,2), ...
                            -1*route2_p2(1,3),route2_p2(2,3));

path3=GetPointLineDistance(radar_raw_scene2(i,1),radar_raw_scene2(i,2), ...
                            -1*route2_p2(1,3),route2_p2(2,3), ...
...
path1=GetPointLineDistance(radar_raw_scene3(i,3),radar_raw_scene3(i,4), ...
                            -1*route1_p2(1,1),route1_p2(2,1), ...
                            -1*route1_p2(1,2),route1_p2(2,2));

path2=GetPointLineDistance(radar_raw_scene3(i,3),radar_raw_scene3(i,4), ...
                            -1*route1_p2(1,2),route1_p2(2,2), ...
                            -1*route1_p2(1,3),route1_p2(2,3));

path3=GetPointLineDistance(radar_raw_scene3(i,3),radar_raw_scene3(i,4), ...
                            -1*route1_p2(1,3),route1_p2(2,3), ...
                            -1*route1_p2(1,4),route1_p2(2,4));
path4=GetPointLineDistance(radar_raw_scene3(i,3),radar_raw_scene3(i,4), ...
                            -1*route1_p2(1,4),route1_p2(2,4), ...
...
path1=GetPointLineDistance(radar_raw_scene3(i,1),radar_raw_scene3(i,2), ...
                            -1*route1_p1(1,1),route1_p1(2,1), ...
                            -1*route1_p1(1,2),route1_p1(2,2));

path2=GetPointLineDistance(radar_raw_scene3(i,1),radar_raw_scene3(i,2), ...
                            -1*route1_p1(1,2),route1_p1(2,2), ...
                            -1*route1_p1(1,3),route1_p1(2,3));

path3=GetPointLineDistance(radar_raw_scene3(i,1),radar_raw_scene3(i,2), ...
                            -1*route1_p1(1,3),route1_p1(2,3), ...
                            -1*route1_p1(1,4),route1_p1(2,4));
path4=GetPointLineDistance(radar_raw_scene3(i,1),radar_raw_scene3(i,2), ...
                            -1*route1_p1(1,4),route1_p1(2,4), ...
