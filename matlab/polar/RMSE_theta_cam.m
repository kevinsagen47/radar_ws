...
rmse_array=[];
length_1=97;
fused_theta1=all_scene_1(1:length_1,1);
fused_theta2=all_scene_1(1:length_1,12);
...
RMSE_theta_cam_p1_s1=rms(rmse_array)
...
RMSE_theta_cam_p2_s1=rms(rmse_array)
%{
f=figure(1);
clf(f,"reset")
...
rmse_array=[];
length_1=95;
fused_theta1=all_scene_2(1:length_1,1);
fused_theta2=all_scene_2(1:length_1,12);
...
RMSE_theta_cam_p1_s2=rms(rmse_array)
...
RMSE_theta_cam_p2_s2=rms(rmse_array)
%{
f=figure(2);
clf(f,"reset")
...
rmse_array=[];
length_1=113;
fused_theta1=all_scene_3(16:length_1,1);
fused_theta2=all_scene_3(16:length_1,12);
...
RMSE_theta_cam_p1_s3=rms(rmse_array)
...
RMSE_theta_cam_p2_s3=rms(rmse_array)
%{
f=figure(3);
clf(f,"reset")
